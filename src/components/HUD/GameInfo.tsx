...
const StatLine = ({ label, value, icon: IconComponent }: StatLineProps) => (
...
const GameInfo = ({ onCastNuke, spellCooldown = 0, nukeCost = 650 }: GameInfoProps) => {
