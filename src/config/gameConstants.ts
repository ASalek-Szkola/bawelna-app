// \config\gameConstants.ts — Central game constants (no more magic numbers)
 ...
 */
export function getSpawnSpacing(totalInWave: number): number {
 ...
 */
export const DAMAGE_MODIFIERS: Record<string, Record<string, number>> = {
 ...
 */
export function getDamageMultiplier(towerType: string, enemyType: string): number {
